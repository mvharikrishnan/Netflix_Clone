...
mixin _$HomeState {
  ...
  List<HotAndNewData> get pastyearMoviesList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      {String stateID,
      List<HotAndNewData> pastyearMoviesList,
...
class _$HomeStateCopyWithImpl<$Res, $Val extends HomeState>
  ...
  $Res call({
    Object? stateID = null,
    Object? pastyearMoviesList = null,
    ...
    return _then(_value.copyWith(
      stateID: null == stateID
          ...
          : stateID // ignore: cast_nullable_to_non_nullable
              as String,
      pastyearMoviesList: null == pastyearMoviesList
          ? _value.pastyearMoviesList
          : pastyearMoviesList // ignore: cast_nullable_to_non_nullable
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> pastyearMoviesList,
      ...
      : _pastyearMoviesList = pastyearMoviesList,
  ...
  final List<HotAndNewData> _pastyearMoviesList;
  @override
  List<HotAndNewData> get pastyearMoviesList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_pastyearMoviesList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateID: $stateID, pastyearMoviesList: $pastyearMoviesList, trendingMovieList: $trendingMovieList, tenseDramas: $tenseDramas, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._pastyearMoviesList, _pastyearMoviesList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      stateID,
      const DeepCollectionEquality().hash(_pastyearMoviesList),
